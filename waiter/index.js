function addToBill(event) {
    ...
    axios.post('https://crudcrud.com/api/a3c1b25a0bdd49a8a85af2983931fb4c/orders', obj)
        .then((res) => {
            console.log(res);
            showOnscreen(obj);
        })
...
window.addEventListener('DOMContentLoaded',()=>{
    axios.get('https://crudcrud.com/api/a3c1b25a0bdd49a8a85af2983931fb4c/orders')
        .then((res)=>{
...
function deleteOrder(obj, ulElement, liElement) {
    ...
    axios.delete(`https://crudcrud.com/api/a3c1b25a0bdd49a8a85af2983931fb4c/orders/${orderId}`)
        .then((res) => {
            console.log(res);
